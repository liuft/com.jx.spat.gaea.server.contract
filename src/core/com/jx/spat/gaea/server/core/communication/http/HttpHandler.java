...
public class HttpHandler extends SimpleChannelUpstreamHandler implements IServerHandler {
    ...
    private void invoke(HttpContext httpContext, MessageEvent e) {
    	try {
			...
			/**HttpContext 上下文*/
			com.jx.spat.gaea.server.contract.http.HttpContext httpcontext = new com.jx.spat.gaea.server.contract.http.HttpContext();
			com.jx.spat.gaea.server.contract.http.HttpRequest httpRequest = new com.jx.spat.gaea.server.contract.http.HttpRequest();
